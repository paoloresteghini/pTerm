...
export function TabBar({
  ...
  return (
    <Tabs
      ...
      className="h-12 min-w-0 select-none border-b border-border bg-background px-2"
    >
      <TabsList
        className="mt-1.5 h-9 w-full min-w-0 justify-start gap-1 overflow-hidden rounded-lg bg-secondary px-1.5"
      >
